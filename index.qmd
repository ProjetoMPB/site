...
::: {.callout-warning}
## ATUALIZAÇÃO EM 01/04/2024

* Lançamento de seis novos capítulos!
* Possibilidade de comentar e fazer anotações privadas nas páginas.

Para mais detalhes, veja as duas postagens mais recentes no [blog do projeto](blog.qmd).
:::
...
* **Materiais suplementares**
    ...
    * Critérios de cifragem alfanumérica
    * Léxico de tipos acordais
    * Taxonomia funcional

...
A relativa baixa diversidade geral dos 2-gramas de r-palavras em relação aos das r-letras fica visualmente evidente pela simples simples observação dos gráficos de barras abaixo, que apresentam as 30 mais comuns sequências de cada repertório. Isso se expressa pela presença (maciça, em certos casos, como no *corpus* Djavan) de "planaltos" que correspondem equivalências percentuais entre 2-gramas (e denotam, consequentemente, baixa consistência de padrões rítmicos em médio nível).

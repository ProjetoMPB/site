...
Como o que foi feito com a estratégia 1, um protocolo para composição assistida pode ser aqui também definido:
...
![Codificação dos segmentos da [@fig-comp13].](../figs/composicao-14.png){width=80% #fig-comp14}

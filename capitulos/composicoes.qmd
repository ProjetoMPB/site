...
(2) Gerar, por intermédio do algoritmo-compositor *corporakov_contorno.py*, uma c-palavra correspondente à r-palavra-semente com a qual -- importante destacar -- deve compartilhar a cardinalidade, de maneira que ambas possam se integrar em uma unidade referencial "fenotípica".^[Tal unidade pode ser aproximadamente associada à ideia de *Grundgestalt*, de Arnold Schoenberg. Para maiores detalhes sobre o conceito, ver, entre outras fontes, @almada-mda.] A [@fig-comp18] propõe uma alternativa para o exemplo da [@fig-comp17], incluindo a acoplagem das duas palavras referenciais.

![Exemplo de geração de uma c-palavra referencial compatível com a r-palavra da [@fig-comp17], com a qual é acoplada, formando a "Grundgestalt" da peça a ser composta.](../figs/composicao-18.png){width=80% #fig-comp18}

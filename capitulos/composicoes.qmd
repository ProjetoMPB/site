...
![Exemplo de geração de uma r-palavra referencial.](../figs/composicao-17.png){width=50% #fig-comp17}

(2) Gerar uma c-palavra correspondente à r-palavra-semente com a qual -- importante -- deve compartilhar a cardinalidade.

^[Formando uma unidade referencial que pode ser aproximadamente associada à ideia de *Grundgestalt*, de Arnold Schoenberg. Para maiores detalhes sobre o conceito, ver, entre outras fontes, @almada-mda.]

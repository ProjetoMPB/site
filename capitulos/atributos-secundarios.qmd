...
![Distribuição das inflexões por *corpus* (em percentuais).](../figs/atri-sec-24.png){width=60%}
...
![Distribuição das superclasses de notas-estruturais por *corpus* (em percentuais).](../figs/atri-sec-25.png){width=60%}

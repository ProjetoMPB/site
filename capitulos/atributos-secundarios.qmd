...
![Distribuição de classes (e/ou subclasses) de categorias funcionais por *corpus* (em percentuais). A última coluna ("?") se refere a situações funcionais não identificadas nas análises.](../figs/atri-sec-09.png){width=60%}

...
![Perfil métrico por *corpus* (em percentuais).](../figs/atri-sec-29.png){width=100%}
...
![Distribuição das r-letras contramétricas por *corpus* (em percentuais).](../figs/atri-sec-30.png){width=60%}

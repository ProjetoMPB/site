...
![Total de relações binárias funcionais distintas por *corpus*.](../figs/atri-sec-21.png){width=100%}
...
![Distribuição de relações binárias funcionais em alto nível por *corpus* (n = quantidade de RBFs; p = percentagem em relação ao todo).](../figs/atri-sec-22.png){width=80%}

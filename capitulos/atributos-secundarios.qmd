...
![Distribuição das categorias funcionais da subclasse "Anti-subV" (aSUB) por *corpus* (em percentuais).](../figs/atri-sec-19.png){width=80%}
...
![Total de relações binárias funcionais distintas por *corpus* (em percentuais).](../figs/atri-sec-21.png){width=40%}

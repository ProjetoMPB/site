...
- 2H1c -- examina em maiores detalhes os conteúdos das superclasses, considerando a distribuição de sete classes de RBTs, as "notáveis" HOM, REL, D/SD e as "não notáveis" MED, QUA, STM, TOM, TRI. Por hipótese, a predominância da classe MED é um indicativo de pertencimento ao subconjunto-alvo, ou seja, um *marcador estilístico centrípeto* (ver capítulo sobre o estilo).

---

**2H2** -- nível dos tipos acordais (contém quatro aspectos):

- 2H2a -- informa a quantidade de tipos acordais (TAs) distintos em cada *corpus*, bem como seu percentual em relação ao total, de acordo com o modelo GTA (ver capítulo dos modelos teóricos). Por hipótese, a  diversidade de TAs seria um possível marcador centrípeto (também em relação ao subconjunto JAZZ).
...
\subsubsection{2M2a}
 ...
 \caption{Distribuição das classes de c-letras por \textit{corpus}.}
    \begin{tabular}{l | c | c | c | c }
    \hline
    Corpus & u & P/p & A/a & S/s \\
    \hline
    \rowcolor{Grayx} 
 Jazz & 11.6 & \textbf{52.8} & 21.2 & 14.4 \\
        \hline 
\rowcolor{Gray} 
    Choro & 5.1 & \textbf{50.2} & 36.2 & 8.5 \\
        \hline    
\rowcolor{Gray} 
Samba  & 25.0 & \textbf{46.9} & 23.1 & 4.9 \\
\hline         
    Tom Jobim   & 16.6 & \textbf{58.3} & 21.3 & 3.9 \\
         \hline     
    Ivan Lins   & 22.5 & \textbf{48.1} & 21.3 & 8.1 \\
         \hline  
Chico Buarque & 24.7 & \textbf{51.6} & 16.9 & 6.7 \\
        \hline    
Edu Lobo  & 19.9 & \textbf{49.1} & 20.6 & 10.4 \\
        \hline  
Caetano Veloso & 17.7 & \textbf{52.2} & 27.0 & 3.1 \\
        \hline  
Djavan & 19.4 & \textbf{45.3} & 29.3 & 6.0 \\
        \hline   
João Bosco & 25.8 & \textbf{48.1} & 20.4 & 5.7 \\
\hline         
Milton Nascimento & 39.8 & \textbf{42.4} & 15.1 & 2.7 \\
        \hline  
Gilberto Gil & 22.4 & \textbf{47.3} & 27.8 & 2.4 \\
\hline 
Rita Lee & 29.9 & \textbf{47.3} & 19.5 & 3.3  \\
\hline         
    \end{tabular}
    \label{tabela27}
\end{table}

...
![Distribuição das categorias funcionais da subclasse "Anti-napolitanos" (aNP) por *corpus* (em percentuais).](../figs/atri-sec-19.png){width=60%}

![Distribuição das categorias funcionais da subclasse "Anti-subV" (aSUB) por *corpus* (em percentuais).](../figs/atri-sec-19.png){width=100%}

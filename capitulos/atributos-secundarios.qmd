...
![Total de relações binárias tonais distintas por *corpus* (percentuais entre parênteses).](../figs/atri-sec-01.png){width=40%}
...
![Distribuição das relações binárias tonais notáveis por *corpus*.](../figs/atri-sec-02.png){width=50%}
...
![Distribuição de relações binárias funcionais em alto nível por *corpus* (n = quantidade de RBFs; p = percentagem em relação ao todo).](../figs/atri-sec-19.png){width=60%}
...
![Distribuição das classes de c-letras por *corpus* (em percentuais).](../figs/atri-sec-27.png){width=40%}
...
![Distribuição das c-letras por *corpus* (em percentuais).](../figs/atri-sec-28.png){width=80%}

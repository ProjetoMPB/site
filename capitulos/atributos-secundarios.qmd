...
![Distribuição das categorias funcionais da classe "Empréstimos cromáticos de primeira ordem" (E1) por *corpus* (em percentuais).](../figs/atri-sec-13.png){width=100%}
...
![Distribuição das categorias funcionais da classe "Empréstimos cromáticos de segunda ordem" (E2) por *corpus* (em percentuais).](../figs/atri-sec-14.png){width=70%}

...
![Total de relações binárias tonais distintas por *corpus* (percentuais entre parênteses).](../figs/atri-sec-01.png){width=35%}
...
![Distribuição das relações binárias tonais notáveis por *corpus*.](../figs/atri-sec-02.png){width=55%}
...
![Distribuição das classes de relações binárias tonais por *corpus* (números indicam percentuais).](../figs/atri-sec-03.png){width=70%}
...
![Distribuição dos conteúdos dos *genera* por *corpus* (em percentuais).](../figs/atri-sec-05.png){width=75%}
...
![Distribuição de protoacordes e variantes por *corpus* (em percentuais).](../figs/atri-sec-06.png){width=45%}
...
![Distribuição das categorias funcionais da subclasse "SubV" (SUBV) por *corpus* (em percentuais).](../figs/atri-sec-12.png){width=70%}
...
![Distribuição das categorias funcionais da classe "Empréstimos cromáticos de segunda ordem" (EC2) por *corpus* (em percentuais).](../figs/atri-sec-14.png){width=70%}
...
![Distribuição de relações binárias funcionais em alto nível por *corpus* (n = quantidade de RBFs; p = percentagem em relação ao todo).](../figs/atri-sec-19.png){width=65%}
...
![Distribuição das notas diatônicas por *corpus*, considerando modos maior e menor (em percentuais).](../figs/atri-sec-23.png){width=65%}
...
Observamos também uma certa uniformidade no que se refere à distribuição das inflexões, que correspondem, em média a 1/5 das notas melódicas (confirmando aproximadamente o senso comum analítico). Num olhar mais detalhado, percebemos como o *corpus* Choro é o que apresenta a maior percentagem dessa categoria de nota-função (24.3 %), o que é também uma informação consistente em relação ao que se conhece informalmente obre o comportamento da melodia nesse gênero.^[Dos *corpora* de análise, Cartola e João Bosco são os que possuem maiores percentuais de inflexões, acima de 23%.]
...
![Distribuição das classes de c-letras por *corpus* (em percentuais).](../figs/atri-sec-27.png){width=50%}

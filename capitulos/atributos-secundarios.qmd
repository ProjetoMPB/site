...
![Distribuição das superclasses de notas-estruturais por *corpus* (em percentuais).](../figs/atri-sec-25.png){width=30%}
...
![Distribuição das classes de notas-estruturais por *corpus* (em percentuais).](../figs/atri-sec-26.png){width=40%}

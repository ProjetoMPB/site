...
![Distribuição das categorias funcionais das subclasse "Dominante secundários" (DS) e "II secundários" (IIs) por *corpus* (em percentuais).](../figs/atri-sec-11.png){width=60%}

...
![Distribuição das relações binárias tonais notáveis por *corpus*.](../figs/atri-sec-02.png){width=60%}
...
![Distribuição dos conteúdos dos *genera* por *corpus* (em percentuais).](../figs/atri-sec-05.png){width=70%}
...
![Distribuição de protoacordes e variantes por *corpus* (em percentuais).](../figs/atri-sec-06.png){width=50%}
...
![Distribuição das categorias funcionais da classe "Empréstimos cromáticos de segunda ordem" (EC2) por *corpus* (em percentuais).](../figs/atri-sec-14.png){width=60%}
...
![Distribuição das inflexões por *corpus* (em percentuais).](../figs/atri-sec-24.png){width=40%}
